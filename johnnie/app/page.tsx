...
function ProjectItem({ p }: { p: Project }) {
  const lightbox = JSON.stringify({ items: [{ url: p.poster, type: "image" }], group: "projects" }, null, 2);
  return (
    <div role="listitem" className="project-item w-dyn-item">
      <a href="#" className="project-link_block w-inline-block w-lightbox">
        <div className="project-embed w-embed">
          <video autoPlay loop poster={p.poster} className="project-video">
        ...
        <div id="w-node-_480febd2-ea4c-f172-8bd0-eedc316394bd-88754749" className="project-content">
          ...
          <div className="project-content_info">
            ...
            <div className="button cc-project">
              ...
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/icons/arrow-right.svg" loading="lazy" alt="" />
            </div>
          </div>
        </div>
        <script type="application/json" className="w-json" dangerouslySetInnerHTML={{ __html: lightbox }} />
      </a>
      {p.award_text ? (
  ...
  return (
    <div role="listitem" className="w-dyn-item">
      ...
      >
        ...
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/icons/arrow-top-right.svg" loading="lazy" alt="" className="feature-arrow" />
      </a>
    </div>
  );
}
          ...
          <div className="container cc-nav">
            ...
            <div className="nav_button w-nav-button">
              <div
                ...
                data-src="/lottie/hamburger-menu.json"
                data-loop="0"
                data-direction="1"
                data-autoplay="0"
                data-renderer="svg"
        ...
        <div className="z-index-top full-width">
          ...
          <div className="hero-bottom_left">
            ...
            <a rel="noreferrer" href="https://www.linkedin.com/in/johnniegomez/" target="_blank" className="social-link_block cc-last w-inline-block">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/icons/logo-linkedin.svg" loading="lazy" width={24} alt="LinkedIn" />
            </a>
          </div>
        </div>
          ...
          <div className="container">
            ...
            <div className="w-layout-grid grid cc-gap-4">
              ...
              <div id="w-node-_105c8a76-68e7-b361-f2e2-5c51f760b469-88754749" className="u-relative">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/images/johnnie-gomez.jpeg"
                  loading="lazy"
                  sizes="(max-width: 2000px) 100vw, 2000px"
                  srcSet="/images/johnnie-gomez-p-500.jpeg 500w, /images/johnnie-gomez.jpeg 2000w"
                  alt=""
                  className="photo"
                />
