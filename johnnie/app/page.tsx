...
const BIO_HTML = `<strong>Johnnie Gomez</strong> is a dog-lover, sticker collector, music aficionado, and conference enthusiast<strong>.</strong> He was born and raised in Buenos Aires, Argentina, but has since moved to <span aria-hidden="true" class="striked">Washington, DC</span> Miami, FL with his adorable wife Dani, Dante, baby Olivia, and their dog <em>lil</em> Honey-boo, where he designs and builds websites remotely for <strong>Anthropic</strong>, as a Member of Technical Staff.<br/><br/>Previously at <strong>Webflow</strong>, he worked closely with a range of internal teams — Growth, Product Design, Lifecycle, and Enterprise — creating high-performing, creative, and accessible web experiences, and evolving the brand alongside a bunch of amazing &amp; talented folks.<br/><br/>Before that, he co-ran the agency <strong>Cruz Barcelona</strong> for over a decade, based in Buenos Aires, Argentina, working with a diverse set of clients across fashion, branding, advertising, illustration, sustainability, editorial, store design, and web design and development.<br/><br/>He also mentors designers at all stages of their careers through <a href="#"><strong>ADPList</strong></a>, and is deeply invested in community and community-driven initiatives.<br/><br/><strong>#SharingIsCaring</strong><br/>`;
    ...
    <div role="listitem" className={`project-item ui-dyn-item${featured ? " is-featured" : ""}`}>
      ...
      >
        <div className="project-media">
          ...
          <div className={`media-badge ${animated ? "is-play" : "is-plus"}`} aria-hidden="true">
            {animated ? (
