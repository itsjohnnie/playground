...
`,
        ...
        {/* Seed a RANDOM start color into --bg + theme-color before first paint,
            ...
            takes over), so we just seed white there. /music is exempt too and
